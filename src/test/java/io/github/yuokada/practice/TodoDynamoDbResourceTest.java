...
class TodoDynamoDbResourceTest {
    ...
    void delete() {
        ...
        given().when().delete("/api/todos/%d".formatted(createdTask.id())).then().statusCode(204);
    }

    @Test
    void deleteNonExistId() {
        given().when().delete("/api/todos/%d".formatted(NON_EXISTENT_ID)).then().statusCode(404);
    }
